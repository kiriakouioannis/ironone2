        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              {hero?.heading || 'Απαλλαχτείτε από το πλύσιμο των ρούχων'}
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              {hero?.description || 'Επαγγελματικές υπηρεσίες πλυσίματος και σιδερώματος'}
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              {hero?.primaryButton && (
                <a 
                  href={hero.primaryButton.link || '/booking'}
              ...
              {hero?.secondaryButton && (
                <a 
                  href={hero.secondaryButton.link || '/services'}
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl transform hover:scale-105 transition-transform duration-500">
              ...
              <div className="relative z-10 aspect-[4/5] overflow-hidden rounded-3xl">
                {hero?.heroImage ? (
                  ...
                  <img
                    src="/a.png"
                    alt="Freshly ironed white linens"
            ...
            {hero?.statsCard && (
              <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-shadow z-20">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <div className="font-bold text-gray-900">{hero.statsCard.number}</div>
                    <div className="text-sm text-gray-600">{hero.statsCard.label}</div>
                    <div className="text-xs text-gray-500">{hero.statsCard.sublabel}</div>
                  </div>
                </div>
              </div>
            )}
